...
namespace WebApplication1.Controllers
{
    public class CadastroController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Endereco,Telefone")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Endereco,Telefone")] Cadastro cadastro)
        {
            if (ModelState.IsValid)
            {
